...
#Region "Function"
    ...
    Public Function SAVE() As Integer
        ...
        Try
            ...
            'save SIZEMaster
            Dim strCommand As String = "SP_MASTER_SIZEMASTER_SAVE"
            Dim alParameter As New ArrayList
            With alParameter

                .Add(New SqlClient.SqlParameter("@SIZE", alParaval(0)))
    ...
    Public Function UPDATE() As Integer
        ...
        Try
            ...
            'save SIZEMaster
            Dim strCommand As String = "SP_MASTER_SIZEMASTER_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
                ...
                .Add(New SqlClient.SqlParameter("@yearid", alParaval(5)))
                .Add(New SqlClient.SqlParameter("@transfer", alParaval(6)))
                .Add(New SqlClient.SqlParameter("SIZEID", alParaval(7)))
