    ...
    Public Function SAVE() As Integer
        ...
        Try
            ...
            With alParameter
                ...
                I += 1
                .Add(New SqlClient.SqlParameter("@BOSSMOBILENO", alParaval(I)))
                I += 1
                ...
                .Add(New SqlClient.SqlParameter("@STREET", alParaval(I)))
                I += 1

                .Add(New SqlClient.SqlParameter("@ISBANK", alParaval(I)))
                I += 1
                ...
                .Add(New SqlClient.SqlParameter("@ISBANK1", alParaval(I)))
                I += 1
                .Add(New SqlClient.SqlParameter("@BANK1", alParaval(I)))
                I += 1
                .Add(New SqlClient.SqlParameter("@ACCOUNTNO1", alParaval(I)))
                I += 1
