...
#Region "Function"
    ...
    Public Function SAVE() As Integer
        ...
        Try
            ...
            'save MAKEMaster
            Dim strCommand As String = "SP_MASTER_MAKEMASTER_SAVE"
            Dim alParameter As New ArrayList
            With alParameter

                .Add(New SqlClient.SqlParameter("@MAKE", alParaval(0)))
    ...
    Public Function UPDATE() As Integer
        ...
        Try
            ...
            'save MAKEMaster
            Dim strCommand As String = "SP_MASTER_MAKEMASTER_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
                ...
                .Add(New SqlClient.SqlParameter("@yearid", alParaval(5)))
                .Add(New SqlClient.SqlParameter("@transfer", alParaval(6)))
                .Add(New SqlClient.SqlParameter("@MAKEID", alParaval(7)))
