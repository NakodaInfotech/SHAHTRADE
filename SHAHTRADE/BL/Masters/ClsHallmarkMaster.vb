...
Public Class ClsHallmarkMaster
...
#Region "Function"
    ...
    Public Function SAVE() As Integer
        ...
        Try
            ...
            'save Taxmaster
            Dim strCommand As String = "SP_MASTER_HALLMARKMASTER_SAVE"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@HALLMARKname", alParaval(0)))
    ...
    Public Function UPDATE() As Integer
        ...
        Try
            ...
            'save Taxmaster
            Dim strCommand As String = "SP_MASTER_HALLMARKMASTER_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@HALLMARKname", alParaval(0)))
                .Add(New SqlClient.SqlParameter("@remarks", alParaval(1)))
                ...
                .Add(New SqlClient.SqlParameter("@yearid", alParaval(5)))
                .Add(New SqlClient.SqlParameter("@transfer", alParaval(6)))
                .Add(New SqlClient.SqlParameter("@HALLMARKid", alParaval(7)))
    ...
    Public Function DELETE() As DataTable
        ...
        Try
            strcommand = "SP_MASTER_HALLMARKMASTER_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@HALLMARKNAME", alParaval(0)))
