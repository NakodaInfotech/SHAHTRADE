    ...
    Public Function SAVE() As Integer
        ...
        Try
            ...
            With alParameter
                ...
                I += 1
                .Add(New SqlClient.SqlParameter("@RATEGREATERTHAN", alParaval(I)))
                I += 1
                ...
                I += 1
                .Add(New SqlClient.SqlParameter("@EXPORTCGST", alParaval(I)))
                I += 1
                .Add(New SqlClient.SqlParameter("@EXPORTSGST", alParaval(I)))
                I += 1
                .Add(New SqlClient.SqlParameter("@EXPORTIGST", alParaval(I)))
                I += 1
