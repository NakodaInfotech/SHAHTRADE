...
#Region "Function"
    ...
    Public Function SAVE() As Integer
        ...
        Try
            ...
            'save PATTAMaster
            Dim strCommand As String = "SP_MASTER_PATTAMASTER_SAVE"
            Dim alParameter As New ArrayList
            With alParameter

                .Add(New SqlClient.SqlParameter("@PATTA", alParaval(0)))
    ...
    Public Function Update() As Integer
        ...
        Try
            ...
            'save PATTAMaster
            Dim strCommand As String = "SP_MASTER_PATTAMASTER_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
                ...
                .Add(New SqlClient.SqlParameter("@yearid", alParaval(5)))
                .Add(New SqlClient.SqlParameter("@transfer", alParaval(6)))
                .Add(New SqlClient.SqlParameter("PATTAID", alParaval(7)))
