...
#End Region
    ...
    Public Function SAVE() As DataTable
        ...
        Try
            'save  order
            Dim strCommand As String = "SP_TRANS_LABOURISSUE_SAVE"
    ...
    Public Function UPDATE() As Integer
        ...
        Try
            'update order
            Dim strCommand As String = "SP_TRANS_LABOURISSUE_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function SELECTLABOURISSUE() As DataTable
        Dim dtTable As DataTable
        Try

            Dim strCommand As String = "SP_TRANS_LABOURISSUE_SELECT"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function DELETE() As Integer
        Dim intResult As Integer
        Try
            Dim strCommand As String = "SP_TRANS_LABOURISSUE_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@ISSUENO", alParaval(0)))
                .Add(New SqlClient.SqlParameter("@YearID", alParaval(1)))
