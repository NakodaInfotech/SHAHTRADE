...
#End Region
    ...
    Public Function save() As DataTable
        ...
        Try
            'save  order
            Dim strCommand As String = "SP_TRANS_SALE_SALEQUOTATION_SAVE"
    ...
    Public Function update() As Integer
        ...
        Try
            'update order
            Dim strCommand As String = "SP_TRANS_SALE_SALEQUOTATION_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function selectNO() As DataTable
        ...
        Try
            ...
            Dim strCommand As String = "SP_TRANS_SALE_SALEQUOTATION_SELECT"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@QUOTENO", alParaval(0)))
    ...
    Public Function Delete() As Integer
        Dim intResult As Integer
        Try
            Dim strCommand As String = "SP_TRANS_SALE_SALEQUOTATION_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@QUOTENO", alParaval(0)))
                .Add(New SqlClient.SqlParameter("@YearID", alParaval(1)))
    ...
    Public Function SAVEUPLOAD() As Integer
        Dim INTRESULT As Integer
        Try
            Dim STRCOMMAND As String = "SP_TRANS_SALE_SALEQUOTATION_SAVEUPLOAD"
