...
#End Region
    ...
    Public Function SAVE() As DataTable
        ...
        Try
            'save  order
            Dim strCommand As String = "SP_TRANS_SALE_SALEINVOICE_SAVE"
            ...
            With alParameter
                ...
                I = I + 1
                .Add(New SqlClient.SqlParameter("@TOTALCOURIERCHGS", alParaval(I)))
                I = I + 1
                ...
                I = I + 1
                .Add(New SqlClient.SqlParameter("@COURIERCHGS", alParaval(I)))
                I = I + 1
                ...
                I = I + 1
                .Add(New SqlClient.SqlParameter("@CHKEXPORTGST", alParaval(I)))
                I = I + 1
    ...
    Public Function UPDATE() As Integer
        ...
        Try
            'update order
            Dim strCommand As String = "SP_TRANS_SALE_SALEINVOICE_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function selectNO() As DataTable
        ...
        Try
            ...
            Dim strCommand As String = "SP_TRANS_SALE_SALEINVOICE_SELECT"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function Delete() As Integer
        Dim intResult As Integer
        Try
            Dim strCommand As String = "SP_TRANS_SALE_SALEINVOICE_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@INVNO", alParaval(0)))
    ...
    Public Function SAVEUPLOAD() As Integer
        Dim INTRESULT As Integer
        Try
            Dim STRCOMMAND As String = "SP_TRANS_SALE_SALEINVOICE_SAVEUPLOAD"
