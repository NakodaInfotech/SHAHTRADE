...
Public Class InterestCalc
    ...
    Private Sub cmbname_Enter(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmbname.Enter
        Try
            If cmbname.Text.Trim = "" Then fillname(cmbname, False, " AND (GROUP_SECONDARY = 'Sundry Creditors' or GROUP_SECONDARY = 'Sundry Debtors'  OR GROUP_SECONDARY = 'Loans' OR GROUP_SECONDARY = 'Unsecured Loans' OR GROUP_SECONDARY = 'Loans & Advances' OR GROUP_SECONDARY = 'Capital A/C') and ledgers.acc_cmpid = " & CmpId & " and LEDGERS.acc_LOCATIONid = " & Locationid & " and LEDGERS.ACC_YEARID = " & YearId)
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
    ...
    Private Sub cmbname_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cmbname.KeyDown
        Try
            If e.KeyCode = Keys.F1 Then
                ...
                OBJLEDGER.STRSEARCH = " AND (GROUP_SECONDARY = 'Sundry Creditors' or GROUP_SECONDARY = 'Sundry Debtors'  OR GROUP_SECONDARY = 'Loans' OR GROUP_SECONDARY = 'Unsecured Loans' OR GROUP_SECONDARY = 'Loans & Advances' OR GROUP_SECONDARY = 'Capital A/C') and ledgers.acc_cmpid = " & CmpId & " and LEDGERS.acc_LOCATIONid = " & Locationid & " and LEDGERS.ACC_YEARID = " & YearId
    ...
    Private Sub TOOLPRINT_Click(sender As Object, e As EventArgs) Handles TOOLPRINT.Click
        Try
            ...
            If CHKDATE.CheckState = CheckState.Checked Then ALPARAVAL.Add("Interest Statement From : " & Format(dtfrom.Value.Date, "dd/MM/yy").ToString & " To " & Format(dtto.Value.Date, "dd/MM/yyyy").ToString) Else ALPARAVAL.Add("Interest Statement From : " & Format(AccFrom, "dd/MM/yyyy").ToString & " To " & Format(AccTo, "dd/MM/yy").ToString)
