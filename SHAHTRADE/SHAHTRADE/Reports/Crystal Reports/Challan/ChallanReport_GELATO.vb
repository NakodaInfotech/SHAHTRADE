...
Public Class ChallanReport_GELATO
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ChallanReport_GELATO.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SHAHTRADE.ChallanReport_GELATO.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedChallanReport_GELATO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ChallanReport_GELATO = New ChallanReport_GELATO()
        rpt.Site = Me.Site
        Return rpt
    End Function
