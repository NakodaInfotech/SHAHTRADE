...
Public Class SaleInvoiceReportPDF
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "SaleInvoiceReportPDF.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SHAHTRADE.SaleInvoiceReportPDF.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSaleInvoiceReportPDF
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SaleInvoiceReportPDF = New SaleInvoiceReportPDF()
        rpt.Site = Me.Site
        Return rpt
    End Function
