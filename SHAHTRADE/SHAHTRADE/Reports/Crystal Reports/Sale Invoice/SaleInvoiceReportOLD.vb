...
Public Class SaleInvoiceReportOLD
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "SaleInvoiceReportOLD.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SHAHTRADE.SaleInvoiceReportOLD.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSaleInvoiceReportOLD
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SaleInvoiceReportOLD = New SaleInvoiceReportOLD()
        rpt.Site = Me.Site
        Return rpt
    End Function
