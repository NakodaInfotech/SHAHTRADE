...
Public Class SaleInvoiceReportGAJ
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "SaleInvoiceReportGAJ.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SHAHTRADE.SaleInvoiceReportGAJ.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSaleInvoiceReportGAJ
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SaleInvoiceReportGAJ = New SaleInvoiceReportGAJ()
        rpt.Site = Me.Site
        Return rpt
    End Function
