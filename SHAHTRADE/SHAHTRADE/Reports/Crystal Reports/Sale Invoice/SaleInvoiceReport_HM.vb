...
Public Class SaleInvoiceReport_HM
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "SaleInvoiceReport_HM.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SHAHTRADE.SaleInvoiceReport_HM.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSaleInvoiceReport_HM
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SaleInvoiceReport_HM = New SaleInvoiceReport_HM()
        rpt.Site = Me.Site
        Return rpt
    End Function
