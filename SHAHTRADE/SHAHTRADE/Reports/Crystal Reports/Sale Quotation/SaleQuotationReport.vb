...
Public Class SaleQuotationReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SHAHTRADE.SaleQuotationReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSaleQuotationReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SaleQuotationReport = New SaleQuotationReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
