...
Public Class CashMemoReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SHAHTRADE.CashMemoReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCashMemoReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CashMemoReport = New CashMemoReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
