...
Public Class InvoiceGridDetails
    ...
    Private Sub InvoiceGridDetails_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
    ...
    Private Sub TOOLGRIDDETAILS_Click(sender As Object, e As EventArgs) Handles CMBADD.Click
        Try
