Imports BL
Public Class MaterialConsumptionGridDetails
    ...
    Private Sub TOOLEXCEL_Click(sender As Object, e As EventArgs) Handles TOOLEXCEL.Click
        ...
        End Try
    End Sub
    Private Sub MaterialConsumptionGridDetails_Load(sender As Object, e As EventArgs) Handles Me.Load
        Try
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        Try
            Dim OBJMCI As New MaterialConsumption
            OBJMCI.MdiParent = MDIMain
            OBJMCI.Show()
        Catch ex As Exception
            Throw ex
        End Try
    ...
    Sub fillgrid()
        Try
            Dim OBJINV As New ClsMaterialConsumption
            OBJINV.alParaval.Add(0)
            OBJINV.alParaval.Add(YearId)
            Dim dttable As DataTable = OBJINV.SELECTMATERIALCONSUMPTION()
        ...
        End Try
    End Sub
    Private Sub MaterialConsumptionGridDetails_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        Try
