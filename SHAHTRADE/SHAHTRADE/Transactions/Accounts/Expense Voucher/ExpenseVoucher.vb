...
Public Class ExpenseVoucher
    ...
    Function errorvalid() As Boolean
        Try
            ...
            If Convert.ToDateTime(PARTYBILLDATE.Value).Date >= "01/07/2017" Then
    ...
    Sub total()
        ...
        TXTGRANDTOTAL.Text = Format(Val(TXTGRANDTOTAL.Text) + Val(TXTTOTALBILLAMT.Text), "0")
...
LINE1:
        ...
        Try
            If TXTPARTYBILLNO.Text.Trim.Length > 0 Then
                If VALIDATEREFNO() = False Then
                    MsgBox("Party Ref. Already Exists", MsgBoxStyle.Critical, "TEXPRO")
                    e.Cancel = True
                End If
            End If
        Catch ex As Exception
    ...
    Private Sub TXTOTHERAMT_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TXTOTHERAMT.KeyPress
    ...
    Private Sub TXTGRIDTOTAL_Validating(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles TXTGRIDTOTAL.Validating
        Try
            If CMBDRNAME.Text.Trim <> "" And Val(TXTAMT.Text.Trim) <> 0 And TXTSRNO.Text.Trim > 0 Then
                ...
                total()
            Else
                MsgBox("Fill Proper Details", MsgBoxStyle.Critical, "SHAHTRADE")
            End If
        Catch ex As Exception
            If ErrHandle(ex.Message.GetHashCode) = False Then Throw ex
        End Try
