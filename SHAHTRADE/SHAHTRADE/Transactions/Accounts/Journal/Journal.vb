            ...
            If edit = True Then
                ...
                If dt.Rows.Count > 0 Then
                    For Each dr As DataRow In dt.Rows
                        ...
                        gridjournal.Rows.Add(dr("JOURNAL_TYPE").ToString, dr("ACC_CMPNAME").ToString, dr("JOURNAL_PAYTYPE").ToString, dr("JOURNAL_REFNO").ToString, Val(dr("JOURNAL_DEBIT")), Val(dr("JOURNAL_CREDIT")), 0, 0, 0, Val(dr("JOURNAL_AMT")))
...
LINE1:
    ...
    Private Sub journal_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        If ClientName = "MAHAVIR" Then ALLOWMANUALJVNO = True
