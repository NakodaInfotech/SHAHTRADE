...
Public Class PurchaseRegisterDetails
    ...
    Private Sub ExcelExport_Click(sender As Object, e As EventArgs) Handles ExcelExport.Click
        Try
            ...
            PATH = Application.StartupPath & "\Purchase Register.XLS"
            ...
            If chkdate.Checked = False Then PERIOD = AccFrom & " - " & AccTo Else PERIOD = dtfrom.Value.Date & " - " & dtto.Value.Date
            opti.SheetName = "Purchase Register"
            gridregister.ExportToXls(PATH, opti)
            EXCELCMPHEADER(PATH, "Purchase Register", gridregister.VisibleColumns.Count + gridregister.GroupCount)
