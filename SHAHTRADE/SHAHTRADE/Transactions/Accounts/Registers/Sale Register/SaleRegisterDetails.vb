...
Public Class SaleRegisterDetails
    ...
    Private Sub ExcelExport_Click(sender As Object, e As EventArgs) Handles ExcelExport.Click
        Try
            ...
            PATH = Application.StartupPath & "\Sale Register.XLS"
            ...
            opti.SheetName = "Sale Register"
            gridregister.ExportToXls(PATH, opti)
            EXCELCMPHEADER(PATH, "Sale Register", gridregister.VisibleColumns.Count + gridregister.GroupCount)
