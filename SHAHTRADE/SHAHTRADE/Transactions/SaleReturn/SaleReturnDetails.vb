...
Public Class SaleReturnDetails
    ...
    Sub showform(ByVal EDITVAL As Boolean, ByVal SALRETNO As Integer)
        Try
            If USEREDIT = False And USERVIEW = False Then
                ...
                Exit Sub
            End If
            Dim OBJQUOTE As New SaleReturn
            OBJQUOTE.EDIT = EDITVAL
            OBJQUOTE.MdiParent = MDIMain
            OBJQUOTE.TEMPSALRETNO = SALRETNO
    ...
    Private Sub cmdedit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CMDEDIT.Click
        Try
            If USEREDIT = False Then
                ...
                Exit Sub
            End If
            showform(True, gridbill.GetFocusedRowCellValue("SALRETNO"))
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
    ...
    Private Sub TOOLEXCEL_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TOOLEXCEL.Click
        Try
            ...
            PATH = Application.StartupPath & "\Sale Return Details.XLS"
            ...
            EXCELCMPHEADER(PATH, "Sale Return Details", gridbill.VisibleColumns.Count + gridbill.GroupCount, "", PERIOD)
