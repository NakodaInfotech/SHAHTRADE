...
Public Class PurchaseInvoiceDetails
    ...
    Sub showform(ByVal EDITVAL As Boolean, ByVal BILLNO As Integer)
        Try
            If USEREDIT = False And USERVIEW = False Then
                ...
                Exit Sub
            End If
            Dim OBJQUOTE As New PurchaseInvoice
    ...
    Private Sub TOOLEXCEL_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TOOLEXCEL.Click
        Try
            ...
            opti.SheetName = "Purchase Invoice Details"
            gridbill.ExportToXls(PATH, opti)
            EXCELCMPHEADER(PATH, "Purchase Invoice Details", gridbill.VisibleColumns.Count + gridbill.GroupCount, "", PERIOD)
