...
Public Class PurchaseInvoice
    ...
    Sub GETMAX_INVOICE_NO()
        Dim DTTABLE As DataTable = getmax(" isnull(max(BILL_no),0) + 1 ", "  PURCHASEMASTER INNER JOIN REGISTERMASTER ON BILL_REGISTERID = REGISTER_ID ", " AND REGISTER_NAME = '" & CMBREGISTER.Text.Trim & "' AND BILL_YEARID = " & YearId)
    ...
    Private Sub cmdok_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdok.Click
        ...
        Try
            ...
            ALPARAVAL.Add(DELIVERYDATE.Text)
            ALPARAVAL.Add(VALIDTILL.Text)
    ...
    Private Function errorvalid() As Boolean
        ...
        If PARTYBILLDATE.Text <> "__/__/____" Then
            ...
            End If
        End If
        If Convert.ToDateTime(PARTYBILLDATE.Text).Date >= "01/02/2018" And TXTGTOTAL.Text > 50000 Then
    ...
    Sub total()
        ...
        Else
            If CMBEXTRAADDSUB.Text = "Add" Then
                TXTGTOTAL.Text = Format(Val(TXTSUBTOTAL.Text) + Val(TXTTAX.Text) + Val(TXTEXTRACHGS.Text) + Val(TXTROUNDOFF.Text.Trim), "0.00")
            Else
                TXTGTOTAL.Text = Format(Val(TXTSUBTOTAL.Text) + Val(TXTTAX.Text) - Val(TXTEXTRACHGS.Text) + Val(TXTROUNDOFF.Text.Trim), "0.00")
            End If
        End If
    ...
    Sub fillgrid()
        ...
        If GRIDDOUBLECLICK = False Then
            GRIDQUOTE.Rows.Add(Val(TXTSRNO.Text.Trim), TXTPARTNO.Text.Trim, CMBITEMNAME.Text.Trim, TXTHSNCODE.Text.Trim, TXTMAKE.Text.Trim, Format(Val(TXTBOXES.Text.Trim), "0"), Format(Val(TXTEACHBOXES.Text.Trim), "0.00"), Format(Val(TXTQTY.Text.Trim), "0.00"), CMBUNIT.Text.Trim, Format(Val(TXTRATE.Text.Trim), "0.00"), Format(Val(TXTAMOUNT.Text.Trim), "0.00"), Format(Val(TXTOTHERAMT.Text.Trim), "0.00"), Format(Val(TXTTAXABLEAMT.Text.Trim), "0.00"), Val(TXTCGSTPER.Text.Trim), Format(Val(TXTCGSTAMT.Text.Trim), "0.00"), Val(TXTSGSTPER.Text.Trim), Format(Val(TXTSGSTAMT.Text.Trim), "0.00"), Val(TXTIGSTPER.Text.Trim), Format(Val(TXTIGSTAMT.Text.Trim), "0.00"), Format(Val(TXTGRIDTOTAL.Text.Trim), "0.00"))
            getsrno(GRIDQUOTE)
        ElseIf GRIDDOUBLECLICK = True Then
            ...
            GRIDQUOTE.Item(GBOXES.Index, TEMPROW).Value = Format(Val(TXTBOXES.Text), "0.00")
            GRIDQUOTE.Item(GEACHBOXES.Index, TEMPROW).Value = Format(Val(TXTEACHBOXES.Text), "0.00")
    ...
    Private Sub txtrate_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TXTRATE.KeyPress, TXTEACHBOXES.KeyPress, TXTQTY.KeyPress
...
LINE1:
    ...
    Private Sub OpenToolStripButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OpenToolStripButton.Click
        Try
            Dim objpurinv As New PurchaseInvoiceDetails
    ...
    Private Sub TXTBOXES_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TXTBOXES.KeyPress
    ...
    Private Sub TXTEXTRACHGS_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TXTEXTRACHGS.KeyPress, TXTROUNDOFF.KeyPress, txtotherchg.KeyPress
        numdotkeypress(e, sender, Me)
    End Sub

    Private Sub TXTEXTRACHGS_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles TXTEXTRACHGS.Validating, TXTROUNDOFF.Validating, txtotherchg.Validating
        total()
    End Sub
