...
Public Class PurchaseReturnDetails
    ...
    Sub showform(ByVal EDITVAL As Boolean, ByVal BILLNO As Integer)
        Try
            If USEREDIT = False And USERVIEW = False Then
                ...
                Exit Sub
            End If
            Dim OBJQUOTE As New PurchaseReturn
            OBJQUOTE.EDIT = EDITVAL
            OBJQUOTE.MdiParent = MDIMain
            OBJQUOTE.TEMPINVNO = BILLNO
    ...
    Private Sub InvoiceDetails_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub InvoiceDetails_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub TOOLEXCEL_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TOOLEXCEL.Click
        Try
            ...
            PATH = Application.StartupPath & "\Purchase Return Details.XLS"
            ...
            EXCELCMPHEADER(PATH, "Purchase Return Details", gridbill.VisibleColumns.Count + gridbill.GroupCount, "", PERIOD)
