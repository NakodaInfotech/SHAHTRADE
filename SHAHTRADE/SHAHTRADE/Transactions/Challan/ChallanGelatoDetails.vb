...
Public Class ChallanGelatoDetails
    ...
    Sub fillgrid()
        Try
            Dim OBJCHALLAN As New ClsChallanGelato
            OBJCHALLAN.alParaval.Add(0)
            OBJCHALLAN.alParaval.Add(YearId)
            Dim dttable As DataTable = OBJCHALLAN.selectNO()
    ...
    Private Sub CMDEDIT_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CMDEDIT.Click
        Try
            If USEREDIT = False Then
                ...
                Exit Sub
            End If
            showform(True, gridbill.GetFocusedRowCellValue("GDNNO"))
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
