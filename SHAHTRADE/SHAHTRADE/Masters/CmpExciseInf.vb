    ...
    Private Sub CmpExciseInf_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If EDIT = True Then
                ...
                DT = OBJCMN.search("CMP_VATNO, CMP_CSTNO, CMP_STNO, CMP_PANNO, CMP_ECCNO, CMP_EXCISENO, CMP_PLANO, CMP_RANGE, CMP_DIVISION, CMP_EXCISEOFF, CMP_DIVISIONOFF,CMP_COMMISSIONERATE, CMP_HEADINGNO, CMP_GSTIN AS GSTIN, CMP_EWBUSER AS EWBUSER, CMP_EWBPASS AS EWBPASS, CMP_DISPATCHFROM AS DISPATCHFROM, ISNULL(CITY_NAME,'') AS FROMCITY ", "", " CMPMASTER LEFT OUTER JOIN CITYMASTER ON CMP_FROMCITYID = CITY_ID", " AND CMP_NAME = '" & TEMPCMPNAME & "'")
