    ...
    Private Sub cmdbackup_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdbackup.Click
        Try
            ...
            If TEMPMSG = vbYes Then
                ...
                If FileIO.FileSystem.DirectoryExists("C:\SHAHTRADE BACKUP") = False Then FileIO.FileSystem.CreateDirectory("C:\TRAVELMATE BACKUP")

                'IF SAME DATE'S BACKUP EXIST THEN DELETE IT THEN RECREATE IT
                If FileIO.FileSystem.FileExists("C:\SHAHTRADE BACKUP\BACKUP " & Now.Day & "-" & Now.Month & "-" & Now.Year & ".bak") Then FileIO.FileSystem.DeleteFile("C:\TRAVELMATE BACKUP\BACKUP " & Now.Day & "-" & Now.Month & "-" & Now.Year & ".bak")

                Dim OBJCMN As New ClsCommon
                Dim DT As DataTable = OBJCMN.Execute_Any_String(" backup database HOSPITALITY to disk='C:\SHAHTRADE BACKUP\BACKUP " & Now.Day & "-" & Now.Month & "-" & Now.Year & ".bak'", "", "")
