...
Public Class UnitMaster
        ...
        Try
            ...
            If (edit = False) Or (edit = True And LCase(Tempname) <> LCase(txtname.Text.Trim)) Then
                ...
                ElseIf frmString = "PACKINGUNIT" Then
                    ...
                    If dt.Rows.Count > 0 Then
                        MsgBox("Packing Unit Name Already Exists", MsgBoxStyle.Critical, "SHAHTRADE")
                        e.Cancel = True
                    End If
                ElseIf frmString = "SUBPACKINGUNIT" Then
                    ...
                    If dt.Rows.Count > 0 Then
                        MsgBox("Sub Packing Unit Name Already Exists", MsgBoxStyle.Critical, "SHAHTRADE")
                        e.Cancel = True
                    End If
                End If
            End If
            ...
            If txtabbr.Text.Trim <> "" Then
                ...
                If (edit = False) Or (edit = True And LCase(Tempabbr) <> LCase(txtabbr.Text.Trim)) Then
                    ...
                    ElseIf frmString = "PACKINGUNIT" Then
                        ...
                        If dt.Rows.Count > 0 Then
                            MsgBox("Packing Unit Abbr Already Exists", MsgBoxStyle.Critical, "SHAHTRADE")
                            e.Cancel = True
                        End If
                    ElseIf frmString = "SUBPACKINGUNIT" Then
                        ...
                        If dt.Rows.Count > 0 Then
                            MsgBox("Sub Packing Unit Abbr Already Exists", MsgBoxStyle.Critical, "SHAHTRADE")
                            e.Cancel = True
                        End If
                    End If
                End If
    ...
    Private Sub cmddelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmddelete.Click
        ...
        If txtname.Text.Trim <> "" Then
            ...
            If dt.Rows.Count > 0 Then
                MsgBox("Size Name Already Used in Transaction Forms Can't be Delete It", MsgBoxStyle.Critical, "SHAHTRADE")
                Exit Sub
            End If
        ...
        If txtname.Text.Trim <> "" Then
            ...
            If dt.Rows.Count > 0 Then
                MsgBox("Grade Name Already Used in Transaction Forms Can't be Delete It", MsgBoxStyle.Critical, "SHAHTRADE")
                Exit Sub
            End If
