        ...
        Try
            If (edit = False) Or (edit = True And TEMPCMPNAME <> txtcmpname.Text.Trim) Then
                ...
                If dt.Rows.Count > 0 Then
                    MsgBox("Company Name Already Exists", MsgBoxStyle.Critical, "SHAHTRADE")
                    e.Cancel = True
                End If
        ...
        Try
            If cmbstate.Text.Trim <> "" Then
                ...
                If dt.Rows.Count = 0 Then
                    ...
                    Dim tempmsg As Integer = MsgBox("State not present, Add New?", MsgBoxStyle.YesNo, "SHAHTRADE")
                    If tempmsg = vbYes Then
                        cmbstate.Text = a
        ...
        Try
            If cmbcountry.Text.Trim <> "" Then
                ...
                If dt.Rows.Count = 0 Then
                    ...
                    Dim tempmsg As Integer = MsgBox("Country not present, Add New?", MsgBoxStyle.YesNo, "SHAHTRADE")
                    If tempmsg = vbYes Then
                        cmbcountry.Text = a
