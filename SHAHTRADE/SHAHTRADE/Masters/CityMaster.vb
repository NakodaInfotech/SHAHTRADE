                ...
                If txtname.Text.Trim <> Nothing Then
                    ...
                    If frmstring = "CITYMASTER" Then
                        ...
                        If dt.Rows.Count > 0 Then
                            MsgBox("City Name Already Exists", MsgBoxStyle.Critical, "SHAHTRADE")
                            e.Cancel = True
                        End If
                    ElseIf frmstring = "AREAMASTER" Then
                        ...
                        If dt.Rows.Count > 0 Then
                            MsgBox("Area Name Already Exists", MsgBoxStyle.Critical, "SHAHTRADE")
                            e.Cancel = True
                        End If
                    ...
                    ElseIf frmstring = "STATEMASTER" Then
                        ...
                        If dt.Rows.Count > 0 Then
                            MsgBox("State Name Already Exists", MsgBoxStyle.Critical, "SHAHTRADE")
                            e.Cancel = True
                        End If
                    ElseIf frmstring = "COUNTRYMASTER" Then
                        ...
                        If dt.Rows.Count > 0 Then
                            MsgBox("Country Name Already Exists", MsgBoxStyle.Critical, "SHAHTRADE")
                            e.Cancel = True
                        End If
