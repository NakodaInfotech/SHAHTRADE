...
Public Class HSNMaster
    ...
    Function CHECKDUPLICATE() As Boolean
        Try
            ...
            If (EDIT = False) Or (EDIT = True And LCase(TXTHSNCODE.Text) <> LCase(tempHSNCODE)) Then
                dt = objclscommon.search("HSN_CODE", "", "HSNMASTER", " and HSN_CODE = '" & TXTHSNCODE.Text.Trim & "' And HSN_yearid = " & YearId)
                If dt.Rows.Count > 0 Then
                    MsgBox("Code Already Exists", MsgBoxStyle.Critical, "SHAHTRADE")
                    BLN = False
                End If
            End If
            Return BLN
        ...
        Try
            ...
            If EDIT = True Then
                ...
                If DT.Rows.Count > 0 Then
                    ...
                    TXTRATE.Text = DT.Rows(0).Item("RATEGREATERTHAN")
    ...
    Private Sub TXTCGST_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TXTSGST.KeyPress, TXTIGST.KeyPress, TXTCGST.KeyPress, TXTRATE.KeyPress, TXTCGST1.KeyPress, TXTSGST1.KeyPress, TXTIGST1.KeyPress
        Try
